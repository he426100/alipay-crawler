...
class Alipay
{
    ...
    private $cookies;
    private $cache;
    private $cookiePath = 'alipay_cookies_selenium';
    private $config = [];
    private $history = [];
    private $process = [];
    ...
    {
        $process = new Process('php '.ROOT_PATH.'cli.php alipay mail to='.$this->config['to'].' subject='.$subject.' content='.($content ?: $this->driver->getCurrentURL()));
        $process->start();
